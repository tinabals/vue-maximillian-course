<template>
  <form @submit.prevent="submitForm">
    ...
    <div class="form-control" :class="{invalid : ageValidity === 'invalid'}">
      ...
      <input id="age" name="age" type="number" v-model="userAge" @blur="validateAge"/>
      <p v-if="ageValidity === 'invalid'"> Please enter correct Age</p>
    </div>
    <div class="form-control">
      <label for="referrer" v>How did you hear about us?</label>
    ...
    <div class="form-control">
      ...
      <div>
        <input id="how-video" name="how" type="radio" v-model="how" value="how-video"/>
        <label for="how-video">Video Courses</label>
      </div>
      <div>
        <input id="how-blogs" name="how" type="radio" v-model="how" value="how-blogs"/>
        <label for="how-blogs">Blogs</label>
      </div>
      <div>
        <input id="how-other" name="how" type="radio"  v-model="how" value="how-other"/>
...
export default {
  ...
  methods : {
    ...
    validateAge(){
      this.userAge === ' ' ? this.ageValidity = 'invalid' : this.ageValidity = 'valid'
    }
  },
